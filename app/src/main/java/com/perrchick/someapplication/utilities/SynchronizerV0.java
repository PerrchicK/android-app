 ...
 */
public class SynchronizerV0 {
    private static final String TAG = SynchronizerV0.class.getSimpleName();
    ...
    public SynchronizerV0(Runnable lastAction) {
        futureTask = new FutureTask<Object>(lastAction, "done");

        beenCanceled = false;

        AppLogger.log(TAG, "*** creating : " + this);
    }
    ...
    public class Holder {
        private final SynchronizerV0 parent; // Is this necessary? Or it's automatically supplied by JAVA.
        private boolean isReleased;


        private Holder(SynchronizerV0 parent) {
            this.parent = parent;
            isReleased = false;
        }
